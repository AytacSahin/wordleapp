const words = [
    ...
    // Y ➕
    "YABAN", "YAĞIŞ", "YAĞIZ", "YAĞMA", "YAHNİ", "YAHŞİ", "YAHUT", "YAKIN", "YAKIT", "YAKUT", "YALAN", "YALIN", "YALIZ", "YAMAÇ", "YAMAN", "YAMUK", "YANAK", "YANAL", "YANCI", "YANIK", "YANIT", "YANKI", "YANMA", "YANSI", "YAPAY", "YAPIM", "YAPIT", "YARAR", "YAREN", "YARGI", "YARIK", "YARIN", "YARIŞ", "YASAK", "YASAL", "YAŞAM", "YASİN", "YAŞIT", "YAŞLI", "YASSI", "YATAK", "YATAY", "YATIK", "YATIR", "YATSI", "YAVAN", "YAVAŞ", "YAVER", "YAVRU", "YAVUZ", "YAYIN", "YAYLA", "YAZAR", "YAZIK", "YAZIM", "YAZIN", "YAZIŞ", "YAZIT", "YEDEK", "YEĞEN", "YELEK", "YEMEK", "YEMEN", "YEMİN", "YEMİŞ", "YENGE", "YENİK", "YEREL", "YERLİ", "YEŞİL", "YEŞİM", "YETER", "YETİM", "YETİŞ", "YETKİ", "YIĞIN", "YİĞİT", "YIKIK", "YIKIM", "YIKMA", "YILAN", "YİRMİ", "YİTİK", "YİTİM", "YOBAZ", "YOĞUN", "YOKUŞ", "YOLCU", "YONCA", "YONGA", "YORMA", "YÖRÜK", "YORUM", "YOSUN", "YUDUM", "YUFKA", "YULAF", "YUMAK", "YUMRU", "YUMUK", "YUNAN", "YÜNLÜ", "YUNUS", "YÜREK", "YUTAK", "YÜZDE", "YÜZEY", "YÜZME", "YÜZÜK",
    // Z ➕
