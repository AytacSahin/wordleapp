            ...
            <div className="flex flex-col justify-center mt-8">
                <div className="flex justify-center">
                    {turkishChars.map((char, index) => (
                        <div
                            key={index}
                            className="w-12 h-12 border border-gray-600 rounded-xl flex items-center justify-center m-1 cursor-pointer"
                ...
                <div className="flex justify-center">
                    <div
                        className="w-20 h-12 border border-gray-600 rounded-xl flex items-center justify-center m-1 cursor-pointer"
